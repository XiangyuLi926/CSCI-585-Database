...
-- Create tables
CREATE TABLE region (regionID VARCHAR2(32) PRIMARY KEY, vertices NUMBER, shape SDO_GEOMETRY);
CREATE TABLE lion (lionID VARCHAR2(32) PRIMARY KEY, position SDO_GEOMETRY);
CREATE TABLE pond (pondID VARCHAR2(32) PRIMARY KEY, area SDO_GEOMETRY, radius NUMBER);
CREATE TABLE ambulancearea (ambulanceareaID VARCHAR2(32) PRIMARY KEY, area SDO_GEOMETRY, radius NUMBER);
...
-- Insert into pond
INSERT INTO pond VALUES ('P2', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(220,415, 235,430, 220,445)), 15);
INSERT INTO pond VALUES ('P3', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(370,420, 385,435, 370,450)), 15);
INSERT INTO pond VALUES ('P1', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(75,415, 90,430, 75,445)), 15);
INSERT INTO pond VALUES ('P6', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(220,305, 235,320, 220,335)), 15);
INSERT INTO pond VALUES ('P7', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(470,265, 485,280, 470,295)), 15);
INSERT INTO pond VALUES ('P4', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(75,315, 90,330, 75,345)), 15);
INSERT INTO pond VALUES ('P5', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(320,265, 335,280, 320,295)), 15);
INSERT INTO pond VALUES ('P8', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(375,160, 390,175, 375,190)), 15);

-- Insert into ambulancearea
INSERT INTO ambulancearea VALUES ('A1', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(100,310, 190,400, 100,490)), 90);
INSERT INTO ambulancearea VALUES ('A3', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(400,310, 490,400, 400,490)), 90);
INSERT INTO ambulancearea VALUES ('A2', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(250,310, 340,400, 250,490)), 90);
INSERT INTO ambulancearea VALUES ('A5', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(300,10, 390,100, 300,190)), 90);
INSERT INTO ambulancearea VALUES ('A4', SDO_GEOMETRY(2003, NULL, NULL, SDO_ELEM_INFO_ARRAY(1,1003,4), SDO_ORDINATE_ARRAY(400,160, 490,250, 400,340)), 90);

-- Update the USER_SDO_GEOM_METADATA view
INSERT INTO user_sdo_geom_metadata (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID) VALUES ('region','shape',SDO_DIM_ARRAY(SDO_DIM_ELEMENT('X', 0, 600, 0.005), SDO_DIM_ELEMENT('Y', 0, 600, 0.005)), NULL);
INSERT INTO user_sdo_geom_metadata (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID) VALUES ('lion','position',SDO_DIM_ARRAY(SDO_DIM_ELEMENT('X', 0, 600, 0.005), SDO_DIM_ELEMENT('Y', 0, 600, 0.005)), NULL);
INSERT INTO user_sdo_geom_metadata (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID) VALUES ('pond','area',SDO_DIM_ARRAY(SDO_DIM_ELEMENT('X', 0, 600, 0.005), SDO_DIM_ELEMENT('Y', 0, 600, 0.005)), NULL);
INSERT INTO user_sdo_geom_metadata (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID) VALUES ('ambulancearea','area',SDO_DIM_ARRAY(SDO_DIM_ELEMENT('X', 0, 600, 0.005), SDO_DIM_ELEMENT('Y', 0, 600, 0.005)), NULL);

-- Create the spatial index
CREATE INDEX region_idx ON region(shape) INDEXTYPE IS MDSYS.SPATIAL_INDEX;
CREATE INDEX lion_idx ON lion(position) INDEXTYPE IS MDSYS.SPATIAL_INDEX;
CREATE INDEX pond_idx ON pond(area) INDEXTYPE IS MDSYS.SPATIAL_INDEX;
CREATE INDEX ambulancearea_idx ON ambulancearea(area) INDEXTYPE IS MDSYS.SPATIAL_INDEX;
